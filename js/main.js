...
//[80, -115] // Northeast coordinates
//];

var southWest = L.latLng(40, -195),
    northEast = L.latLng(80, -115),
...
var doubleIcon = L.Icon.extend({
	options: {
    iconSize:     [73, 30], // size of the icon
...
var doubleIcon2 = L.Icon.extend({
	options: {
    iconSize:     [65, 30], // size of the icon
    iconAnchor:   [32, 15], // point of the icon which will correspond to marker's location
    popupAnchor:  [12, -15] // point from which the popup should open relative to the iconAnchor
	}
});

var coastsCommunitiesIcon = new doubleIcon2({iconUrl: 'img/coasts_communities.png'}),
...
var tripleIcon = L.Icon.extend({
	options: {
    iconSize:     [105, 31], // size of the icon
...
legend.onAdd = function (map) {
    ...
    var div = L.DomUtil.create('div', 'info legend'),
        grades = ["Climate work", "Coastal work", "Community work"],
        labels = ['img/climatelegend.png', 'img/coastlegend.png', 'img/communitylegend.png'];

    div.innerHTML +=
            (" <img src="+ labels[0] +" height='27' width='129'>") +'<br>';
	div.innerHTML +=
            (" <img src="+ labels[1] +" height='29' width='129'>") +'<br>';
	div.innerHTML +=
            (" <img src="+ labels[2] +" height='29' width='150.5'>") +'<br>';
